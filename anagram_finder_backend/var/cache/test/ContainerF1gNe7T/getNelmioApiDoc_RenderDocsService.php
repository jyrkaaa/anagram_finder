...
class getNelmioApiDoc_RenderDocsService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['nelmio_api_doc.render_docs'] = new \Nelmio\ApiDocBundle\Render\RenderOpenApi(($container->privates['nelmio_api_doc.generator_locator'] ?? $container->load('getNelmioApiDoc_GeneratorLocatorService')), ($container->privates['nelmio_api_doc.render_docs.json'] ??= new \Nelmio\ApiDocBundle\Render\Json\JsonOpenApiRenderer()), ($container->privates['nelmio_api_doc.render_docs.yaml'] ??= new \Nelmio\ApiDocBundle\Render\Yaml\YamlOpenApiRenderer()), NULL);
    }
}
